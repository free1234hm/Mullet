 ...
 */ 
public class TSMinerGui_SaveImage2 extends JPanel
{
	/**
	 * Class constructor
	 */
	public TSMinerGui_SaveImage2(final JFrame theFrame, HeatMap panel)
	{
	...
	public TSMinerGui_SaveImage2(final JFrame theFrame, JScrollPane panel)
	{
		setLayout(new BoxLayout(this, BoxLayout.PAGE_AXIS));
		String[] sznames = ImageIO.getWriterFormatNames();
		JFileChooser theChooser = new JFileChooser();
