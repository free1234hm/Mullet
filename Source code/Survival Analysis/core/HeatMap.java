...
public class HeatMap extends JPanel
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        if (drawYTicks)
        {
            ...
            {
                g2d.drawLine(26, (int)(height - 30 - y * yDist), 30, (int)(height - 30 - y * yDist));
                label = (int)(((y / (double) numYTicks) * (yMax - yMin)) + yMin)+"";
        ...
        if (drawXTicks)
        {
            ...
            for (int x = 0; x <= numXTicks; x++)
            {
                ...
                label = (int)(((x / (double) numXTicks) * (xMax - xMin)) + xMin)+"";
